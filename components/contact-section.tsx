...
export default function ContactSection() {
  ...
  return (
    <div className="contact-wrap">
      ...
      {/* quick contact CTAs */}
      <div className="contact-ctas fade-row">
        <a
          href="https://x.com/k2sbhai"
          target="_blank"
          rel="noopener noreferrer"
      ...
      <p className="contact-note fade-row">
        available for AI content, product launches, web3 community, and
        collaboration work. reach out on any channel — i respond fast.
      </p>
    </div>
  )
}
